...
if isunix
    !mkdir mex
    movefile([name '_mex.mexa64'],['mex/' name '_mex.mexa64'])
    delete *.cc
    delete *.hh
else  
    movefile *mex* mex
...
cd(path);
if isunix
    movefile(name+"_src"+".cc",name+"_src"+".c")
    movefile(name+"_src"+".hh",name+"_src"+".h")
else
    !ren *.cc *.c
    !ren *.hh *.h
end
...
cd(path);
if isunix
    movefile(name+".cc",name+".m")
    movefile(name+".hh",name+".garbage")
else
    !ren *.cc *.m
    !ren *.hh *.garbage
end
